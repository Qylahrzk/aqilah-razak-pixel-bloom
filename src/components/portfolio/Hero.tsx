      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-12 lg:gap-6">
        ...
        >
          ...
          <div className="mt-8 flex gap-3 text-muted-foreground">
            {[
              {
                label: "LinkedIn",
                href: "https://www.linkedin.com/in/nur-aqilah-abdul-razak/",
                svg: (
              ...
              {
                label: "Instagram",
                href: "https://www.instagram.com/qshazakk",
                svg: (
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {
                label: "YouTube",
                href: "https://youtube.com/@nrukaaz",
                svg: (
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {
                label: "GitHub",
                href: "https://github.com/Qylahrzk",
                svg: (
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap gap-x-5 gap-y-2 text-sm font-medium text-foreground">
            ...
            <a href="#achievements" className="border-b-2 border-transparent pb-0.5 transition-colors hover:border-pink">My Certs</a>
            <span className="text-muted-foreground">|</span>
